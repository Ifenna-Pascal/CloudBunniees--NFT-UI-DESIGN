...
function Hero() {
  return (
    <div id="home" className="lg:h-screen h-screen  relative w-full max-w-screen bg-hero_mobile lg:bg-hero bg-no-repeat relative  lg:bg-bottom bg-center  bg-cover">
      <Navbar />
