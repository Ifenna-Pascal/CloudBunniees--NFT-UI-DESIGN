...
function Hero() {
  return (
    <div id="home" className="lg:h-screen h-screen max-w-[1920px] relative w-screen bg-hero_mobile lg:bg-hero bg-no-repeat relative  lg:bg-bottom bg-center  bg-cover">
      <Navbar />
